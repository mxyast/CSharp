...
namespace ConsoleUI
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            CategoryManager categoryManager = new CategoryManager(); categoryManager.Add(category1);
            ...
            Category categoryBir = new Category();
            ...
            //Sifirdan proje oluşturunuz-->TobetoETrade
